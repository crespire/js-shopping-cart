...
function Sidebar(props) {
  ...
  return (
    <div className="flex-none min-w-fit w-1/4 p-2 background-slate-100 border-solid border-black border-r overflow-y-scroll overflow-x-hidden">
      {checkoutFlow
        ? <Checkout cart={cart} toggleCheckout={toggleCheckout} setCheckoutInformation={setCheckoutInformation} checkoutInformation={checkoutInformation} checkoutStep={checkoutStep} checkoutNext={checkoutNext} checkoutBack={checkoutBack} />
